...
router.post('/register', (req, res) => {
  ...
  try {
    ...
    const newUser = { id, username, email, password: hash, created_at: new Date().toISOString() };
...
router.get('/me', auth, (req, res) => {
  ...
  res.json({ id: row.id, username: row.username, email: row.email, created_at: row.created_at });
});
